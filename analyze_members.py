...
analyze_members.py
------------------
会員購買データを3つのSheetに集計して出力する。

  Sheet1「概要」        : 全体 vs 会員の金額サマリ
...
def write_excel(output_path, df_summary, df_members, df_products):
    print(f"\n  書込中: {output_path}")
...
def main():
    ...
    write_excel(args.output, df_summary, df_members, df_products)
